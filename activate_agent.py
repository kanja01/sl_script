...
http://sldn.softlayer.com/reference/services/SoftLayer_Monitoring_Agent/activate
...
try:
    ...
    print("Unable to activate the monitor agent: faultCode=%s, faultString=%s" % (e.faultCode, e.faultString))
    exit(1)